    ...
    <div className="wrapper clear">
      <header className="d-flex justify-between align-center">
        <div className="header-left d-flex align-center">
          <img src="/images/myAvatar.png" alt='ShopLogo' className="header-logo-image mr-15" />
          <div className="header-left-info">
            <h2 className="text-uppercase">Super Sneakers</h2>
            <p>Магазин самых стильных кроссовок</p>
          </div>
        </div>
        ...
        <article className="sneakers-container d-flex">
          <article className="card">
            ...
            <div className="d-flex justify-between">
              ...
              <button>
                <img width={11} height={11} src="/images/plus.svg" alt="Add item" />
              </button>
            </div>
          </article>
          <article className="card">
            <img width={133} height={112} src="/images/sneakers/image 2.jpg" alt="sneakers" />
            <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="d-flex justify-between">
              <div className="d-flex flex-column align-center">
                <span>Цена:</span>
          ...
          <article className="card">
            <img width={133} height={112} src="/images/sneakers/image 3.jpg" alt="sneakers" />
            <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="d-flex justify-between">
              <div className="d-flex flex-column align-center">
                <span>Цена:</span>
          ...
          <article className="card">
            <img width={133} height={112} src="/images/sneakers/image 4.jpg" alt="sneakers" />
            <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="d-flex justify-between">
              <div className="d-flex flex-column align-center">
                <span>Цена:</span>
